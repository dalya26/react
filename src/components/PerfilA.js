...
const items = [
   ...
   return (
    ...
    <Splitter style={{ marginLeft:'20px', marginRight:'20px', marginTop:'20px', marginBlockEnd:'20px' }}>
            ...
            <Avatar image="https://www.prensalibre.com/wp-content/uploads/2018/12/685f8470-ec53-410e-83ea-5e30c4319a40.jpg?quality=52&w=760&h=430&crop=1" className="mr-2" shape="circle" />
                        <div className="flex flex-column align">
                            <strong className="font-bold" style={{fontFamily:'monospace', fontSize:'20px'}}>Camila Cruz</strong>
                            <p className="text-sm">Alumno (a)</p>
                        </div>
            </Card>
                    ...
                    <SplitterPanel size={85}>
                        <Splitter>
                            <SplitterPanel className="flex align-items-center justify-content-center" size={20}>
                                <div className="card">
                                    <Editor value={text} onTextChange={(e) => setText(e.htmlValue)} style={{ height: '320px' }} placeholder="Asiste diariamente a tus clases. Es parte de una persona con disciplina." />
                                </div>
                            </SplitterPanel>
