...
<Card role="region" className="md:w-25rem">   
  <center> 
    ...
    <Image src={imagen(`./inicio4.png`)} alt="Image" width="250"/>
      ...
      <br></br>
      <div className="card flex justify-content-center">
          <InputText name="rol" value={datosLogin.rol = '2'} onChange={(e) => inputChange(e)} disabled />
      </div>
      <br></br>
      <div className="card flex justify-content-center">
...
export default LoginComponentM